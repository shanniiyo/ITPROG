...
--
-- Host: localhost
-- Generation Time: Apr 04, 2026 at 07:16 AM
...
CREATE TABLE `admin_user` (
  ...
  `role` enum('staff','manager','sys_admin','') NOT NULL DEFAULT 'staff'
...
--
-- Table structure for table `locker_reports`
--
...
CREATE TABLE `locker_reports` (
  ...
  `issue_type` enum('Cannot Open Locker','Payment Issue','Damaged Locker','Item Left Behind','Other') NOT NULL,
...
(3, 'medium', 'Taguig', 'available', 1, 80.00),
(5, 'large', 'Paranaque', 'occupied', 1, 90.00);
...
(1, 'shanjdipatuan@gmail.com', '$2y$10$SfjfmT.EmV.immt3pkPNJub7DZxW6WAmOLWrZM4.yy17J5UkoIOBO', 'Shan Junaid Dipatuan', 'shanjdipatuan@gmail.com', '09167112520'),
...
--
-- Indexes for table `locker_reports`
--
ALTER TABLE `locker_reports`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_rsvp_id` (`rsvp_id`),
  ADD KEY `FK_locker_id` (`locker_id`);
...
--
-- AUTO_INCREMENT for table `locker_reports`
--
ALTER TABLE `locker_reports`
...
--
-- Constraints for table `locker_reports`
--
ALTER TABLE `locker_reports`
  ADD CONSTRAINT `FK_locker_id` FOREIGN KEY (`locker_id`) REFERENCES `locker_rsvp` (`locker_id`),
  ADD CONSTRAINT `FK_rsvp_id` FOREIGN KEY (`rsvp_id`) REFERENCES `rsvp_details` (`rsvp_id`);
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `type`       ENUM('confirmation','expiration_reminder','cancellation','extension') NOT NULL,
  ...
  CONSTRAINT `fk_notif_rsvp` FOREIGN KEY (`rsvp_id`) REFERENCES `rsvp_details` (`rsvp_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;